...
> `ConfigureAwait` налаштовує `await`, а не завдання. І сам по собі `ConfigureAwait` не захищає від дедлоків: якщо хоч один внутрішній метод його не використовує, блокування все одно можливе.
{: .prompt-info }
